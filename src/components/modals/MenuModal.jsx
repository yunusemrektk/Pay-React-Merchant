    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <motion.div
        ...
        className="
          ...
          /* — Mobil (default) — */
          p-4                 /* dar padding */
          w-full max-w-sm     /* max genişlik 24rem */
          max-h-[85vh]        /* yüksekliği %85 viewport */
          overflow-y-auto     /* dikey scroll */

          /* — Sm ve üzeri (>=640px) — */
          sm:p-6              /* orijinal padding */
          sm:max-w-md         /* max genişlik 28rem */
          sm:max-h-none       /* yükseklik kısıtı kalksın */
          sm:overflow-visible /* taşmaya izin */
        "
      >
        {/* Close */}
        <CloseButton
